...
$this->title = Html::encode(Yii::t('cms', 'Search Result: {s}', ['s' => $s]) . ' - ' . Option::get('sitetitle'));
$this->params['breadcrumbs'][] = Html::encode(Yii::t('cms', 'Search Result: {s}', ['s' => $s]));
...
<div class="archive post-index">
    <header id="archive-header" class="archive-header page-header">
        <h1><?= Html::encode(Yii::t('cms', 'Search Result: {s}', ['s' => $s])) ?></h1>
