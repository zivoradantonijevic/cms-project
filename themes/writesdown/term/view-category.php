...
$this->title = Html::encode($term->taxonomy->singular_name);
$this->params['breadcrumbs'][] = Html::encode($term->name);
$this->params['subtitle'] = Html::encode($term->name);
?>
        ...
        <?php foreach ($posts as $post) : ?>
            <article class="hentry">
                <header class="entry-header">
                    <h3 class="entry-title"><?= Html::a(Html::encode($post->title), $post->url) ?></h3>
