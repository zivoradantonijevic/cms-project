...
class Taxonomy extends ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'name' => Yii::t('cms', 'Name'),
            'slug' => Yii::t('cms', 'Slug'),
            'hierarchical' => Yii::t('cms', 'Is Hierarchical'),
            'singular_name' => Yii::t('cms', 'Singular Name'),
            'plural_name' => Yii::t('cms', 'Plural Name'),
            'menu_builder' => Yii::t('cms', 'Is Menu Builder'),
        ];
    }
    ...
    {
        return [
            self::HIERARCHICAL => Yii::t('cms', 'Yes'),
            self::NOT_HIERARCHICAL => Yii::t('cms', 'No'),
        ];
    }
    ...
    {
        return [
            self::MENU_BUILDER => Yii::t('cms', 'Yes'),
            self::NOT_MENU_BUILDER => Yii::t('cms', 'No'),
        ];
    }
