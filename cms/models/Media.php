...
class Media extends ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'post_id' => Yii::t('cms', 'Attached to'),
            'title' => Yii::t('cms', 'Title'),
            'excerpt' => Yii::t('cms', 'Caption'),
            'content' => Yii::t('cms', 'Description'),
            'password' => Yii::t('cms', 'Password'),
            'date' => Yii::t('cms', 'Uploaded'),
            'modified' => Yii::t('cms', 'Updated'),
            'slug' => Yii::t('cms', 'Slug'),
            'mime_type' => Yii::t('cms', 'Mime Type'),
    ...
    {
        /* @var $model \cms\models\MediaMeta */
    ...
    /**
     * Get media image thumbnail url. If the version is not found, full size will be returned.
     *
     * @param string $version Version of image thumbnail.
     *
     * @return string
    ...
    public function getThumbnailUrl($version = 'thumbnail')
    {
       ...
       // _p($metadata,1);
        if (preg_match("/^image/", $this->mime_type)) {
            ...
            return $this->getUploadUrl() . $imageSrc;
        }
