...
<div class="register-box">
    ...
    <div class="register-box-body">
        <p class="login-box-msg"><?= Yii::t('cms', 'Register a new membership') ?></p>
        ...
        <?= Html::a(Yii::t('cms', 'I already have a membership'), ['login']) ?>
