...
/* @var $commentParent cms\models\MediaComment */
/* @var $model cms\models\MediaComment */

$this->title = Yii::t('cms', 'Reply Media Comment: {id}', ['id' => $commentParent->id]);
...
$this->params['breadcrumbs'][] = Yii::t('cms', 'Reply Comment');
?>
    ...
    <div class="col-md-8 post-comment-update">
        <div class="box box-primary">
            <div class="box-header">
                ...
                <h3 class="box-title"><?= Yii::t('cms', 'Reply to') ?></h3>
            </div>
            <div class="box-body">
