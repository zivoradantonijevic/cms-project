...
/* @var $searchModel cms\models\search\MediaComment */
/* @var $dataProvider yii\data\ActiveDataProvider */
/* @var $media cms\models\Media|null */

$this->title = Yii::t('cms', 'Media Comments');
...
if ($media) {
    ...
    $this->title = Yii::t('cms', 'Media {media} Comments', [
        'media' => $media->id,
    ]);
}
