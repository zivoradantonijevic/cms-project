                    ...
                    <div class="row">
                        <div class="col-xs-4 filter-uploaded">
                            ...
                            echo Html::dropDownList(
                                'post',
                                null,
                                isset($post) ? [$post => Yii::t('cms', 'Uploaded to the post')] : [],
                                ['class' => 'input-sm form-control', 'prompt' => Yii::t('cms', 'All media')]
                            ) ?>
