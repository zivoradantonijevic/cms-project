...
/* @var $model cms\models\search\Media */
...
<div id="media-search" class="collapse media-search">
    ...
    <div class="form-group">
        <?= Html::submitButton(Yii::t('cms', 'Search'), ['class' => 'btn-flat btn btn-primary']) ?>

        <?= Html::resetButton(Yii::t('cms', 'Reset'), ['class' => 'btn-flat btn btn-default']) ?>
