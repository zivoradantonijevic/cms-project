...
$this->title = Yii::t('cms', 'Reading Settings');
...
<div class="options-form">
    ...
    <div class="form-group">
        <?= Html::label(Yii::t('cms', 'Front page displays'), null, ['class' => 'col-sm-2 control-label']) ?>

        <div class="col-sm-7">
            <?= Html::radioList(
                'Option[show_on_front][value]',
                $model->show_on_front->value,
                ['posts' => Yii::t('cms', 'Latest posts')],
                ['separator' => '<br />', 'class' => 'radio']
            ) ?>

            <?= Html::label(Yii::t('cms', 'Front page: '), 'option-front_page') ?>
    ...
    <div class="form-group">
        <div class="col-sm-7 col-sm-push-2">
            ...
            <?= Html::label(Yii::t('cms', 'Posts page: '), 'option-posts_page') ?>
    ...
    <div class="form-group">
        <?= Html::label(
            Yii::t('cms', 'For each article in a feed, show'),
            null,
            ['class' => 'col-sm-2 control-label']
        ) ?>
    ...
    <div class="form-group">
        <?= Html::label(
            Yii::t('cms', 'Search Engine Visibility'),
        ...
        <div class="col-sm-7">
            <div class="checkbox">
                <?= Html::label(
                    ...
                    ) . Yii::t('cms', 'Do not allow search engines to index the site')
                ) ?>

            </div>
            <p class="description">
                <?= Yii::t('cms', "It's up to the search engines to honor this request.") ?>
