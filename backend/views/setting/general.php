...
$this->title = Yii::t('cms', 'General Settings');
...
<div class="options-form">
    ...
    <div class="form-group">
        <?= Html::label(Yii::t('cms', 'Tagline'), 'option-tagline', ['class' => 'col-sm-2 control-label']) ?>
        ...
        <div class="col-sm-7">
            ...
            <p class="description">
                <?= Yii::t('cms', 'In a few words, explain what this site is about.') ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-7">
            ...
            <p class="description">
                <?= Yii::t('cms', 'This address is used for admin purposes, like new user notification.') ?>
    ...
    <div class="form-group">
        <?= Html::label(
            Yii::t('cms', 'Allow New Membership'),
            'option-allow_signup',
            ['class' => 'col-sm-2 control-label']
        ) ?>
        ...
        <div class="col-sm-7">
            <div class="checkbox">
                <?= Html::label(
                    ...
                    ) . Yii::t('cms', ' Allow guest to register on this site')
                ) ?>
    ...
    <div class="form-group">
        <?= Html::label(
            Yii::t('cms', 'New User Default Role'),
            'option-default_role',
            ['class' => 'col-sm-2 control-label']
        ) ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-7">
            ...
            <p class="description"><?= Yii::t('cms', 'Choose a city in the same timezone as you.') ?></p>
        </div>
    </div>

    <div class="form-group">
        <?= Html::label(Yii::t('cms', 'Date Format'), null, ['class' => 'col-sm-2 control-label']) ?>
        ...
        <div class="col-sm-7">
            ...
            <p class="description">
                <?= Html::a(
                    Yii::t('cms', 'Read documentation for more info.'),
    ...
    <div class="form-group">
        <?= Html::label(Yii::t('cms', 'Time Format'), null, ['class' => 'col-sm-2 control-label']) ?>
