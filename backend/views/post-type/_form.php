...
<div class="post-type-form">
    ...
    ])->hint(Yii::t('cms', 'Used for calling of the post_type. Example: post, page, news.')) ?>

    <?= $form->field($model, 'slug')->textInput([
        'maxlength' => 64,
        'placeholder' => $model->getAttributeLabel('slug'),
    ])->hint(Yii::t('cms', 'Used on the url of the taxonomy ( Use - instead of space for better SEO )')) ?>
    ...
    ])->hint(Yii::t('cms', 'The icon use {FontAwesome} and appears on admin side menu', [
