    ...
    public function actionCreate()
    {
        ...
        if (($model->file = UploadedFile::getInstance($model, 'file')) && $model->validate(['file'])) {
            ...
            if (!is_file($configPath)) {
                ...
                return $this->render('create', [
                    'model' => $model,
                    'errors' => [Yii::t('cms', 'File configuration does not exist.')],
                ]);
            }
            ...
            if (is_dir($this->_dir . $baseDir)) {
                $errors['dirExist'] = Yii::t('cms', 'Widget with the same directory already exist.');
            } else {
            ...
            if (!isset($config['title'])
                ...
                $errors[] = Yii::t('cms', 'Invalid configuration.');
            }

            if (!$errors) {
                Yii::$app->getSession()->setFlash('success', Yii::t('cms', 'Widget successfully installed.'));
