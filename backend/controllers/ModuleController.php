...
use cms\models\search\Module as ModuleSearch;
use Yii;
        ...
        if (($model->file = UploadedFile::getInstance($model, 'file')) && $model->validate(['file'])) {
            ...
            if (!$model->file->saveAs($tmpPath)) {
                return $this->render('create', [
                    'model' => $model,
                    'error' => [Yii::t('cms', 'Failed to move uploaded file.')],
                ]);
            }
            ...
            if (!$zipArchive->extractTo($this->_tmp)) {
                ...
                return $this->render('create', [
                    'model' => $model,
                    'error' => [Yii::t('cms', 'Failed to extract file.')],
                ]);
            }
            ...
            if (!is_file($configPath)) {
                ...
                return $this->render('create', [
                    'model' => $model,
                    'error' => [Yii::t('cms', 'File configuration does not exist.')],
                ]);
            }
